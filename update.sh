...
remove_unwanted_packages() {
    local luci_packages=(
        ...
        "luci-app-msd_lite" "luci-app-argon-config" "luci-theme-argon"
    )
    local packages_net=(
    ...
    local small8_packages=(
        ...
        "alist" "opkg" "smartdns" "luci-app-smartdns" "luci-app-argon-config" "luci-theme-argon"
    )
...
install_small8() {
    ./scripts/feeds install -p small8 -f xray-core xray-plugin dns2tcp dns2socks haproxy hysteria \
        ...
        luci-app-passwall luci-app-passwall2 v2dat mosdns luci-app-mosdns adguardhome luci-app-adguardhome ddns-go \
        luci-app-ddns-go taskd luci-lib-xterm luci-lib-taskd luci-app-store quickstart \
        luci-app-quickstart luci-app-istorex luci-app-cloudflarespeedtest netdata luci-app-netdata \
        lucky luci-app-lucky luci-app-openclash luci-app-homeproxy luci-app-amlogic nikki luci-app-nikki \
        tailscale luci-app-tailscale oaf open-app-filter luci-app-oaf easytier luci-app-easytier \
        msd_lite luci-app-msd_lite cups luci-app-cupsd luci-app-wolplus
}
